...
//Configure Sections
$server = "http://studio.brimfield.tv/"; // URL to CableCast server
$host = "http://test.brimfield.tv/"; // URL to webserver hosting files
$imageurl = "http://test.brimfield.tv/roku/images/"; // URL to image files
$VODFile = "vod.xml"; // Name of XML file (needs to match in channel package files on Roku)
$xmlpath = "/home/brimfieldtv/public_html/roku/xml/"; // path to xml file on server
